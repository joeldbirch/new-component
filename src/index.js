...
const templatePath = `./templates/${program.type}.${program.extension}`
const testTemplatePath = `./templates/rtl.spec.js`

// Get all of our file paths worked out, for the user's project.
const componentDir = `${program.dir}/${componentName}`
const componentTestDir = `${program.dir}/${componentName}/__tests__`
const filePath = `${componentDir}/${componentName}.${program.extension}`
const indexPath = `${componentDir}/index.${
  program.extension === `tsx` ? `ts` : `js`
}`
const testPath = `${componentTestDir}/${componentName}.spec.js`
...
mkDirPromise(componentDir)
  ...
  .then(() => {
    return mkDirPromise(componentTestDir)
  })
